...
public class WebUser extends ClassBase {
	...
	public void setUsrId(Long paraUsrId) {
	 ...
	 * 赋值 供应商用户XML描述
	 * 
	 * @param paraUsrScmXml 供应商用户XML描述
	 */
	 ...
	 * 赋值 推荐人电话
	 * 
	 * @param paraRecommendPhone 推荐人电话
	 */
	 ...
	 * 赋值 BBS_SYS_FACE
	 * 
	 * @param paraBbsSysFace BBS_SYS_FACE
	 */
	 ...
	 * 
	 * @param paraBbsHomeVisCount BBS_HOME_VIS_COUNT
	 */
	 ...
	 * 赋值 USR_PIC_BIN
	 * 
	 * @param paraUsrPicBin USR_PIC_BIN
	 */
	 ...
	 * 赋值 USR_NAME_EN
	 * 
	 * @param paraUsrNameEn USR_NAME_EN
	 */
	 ...
	 * 赋值 USR_PARENT_NAME
	 * 
	 * @param paraUsrParentName USR_PARENT_NAME
	 */
	 ...
	 * 赋值 BBS_FACE_METHOD
	 * 
	 * @param paraBbsFaceMethod BBS_FACE_METHOD
	 */
	 ...
	 * 
	 * @param paraIsWeixinSubscribe IS_WEIXIN_SUBSCRIBE
	 */
	 ...
	 * 赋值 BBS_POST_NUM
	 * 
	 * @param paraBbsPostNum BBS_POST_NUM
	 */
	 ...
	 * 赋值 BBS_REPLY_NUM
	 * 
	 * @param paraBbsReplyNum BBS_REPLY_NUM
	 */
	 ...
	 * 赋值 BBS_SCORE_NUM
	 * 
	 * @param paraBbsScoreNum BBS_SCORE_NUM
	 */
	 ...
	 * 赋值 BBS_NICK_NAME
	 * 
	 * @param paraBbsNickName BBS_NICK_NAME
	 */
	 ...
	 * 赋值 AUTH_WEIXIN_JSON
	 * 
	 * @param paraAuthWeixinJson AUTH_WEIXIN_JSON
	 */
	 ...
	 * 赋值 LANGAGE_LEVEL
	 * 
	 * @param paraLangageLevel LANGAGE_LEVEL
	 */
	 ...
	 * 赋值 USR_TIMEZONE
	 * 
	 * @param paraUsrTimezone USR_TIMEZONE
	 */
	 ...
	 * 
	 * @param paraUsrMobileCountryCode USR_MOBILE_COUNTRY_CODE
	 */
	...
	public Object getField(String filedName) {
		...
		if (n.equalsIgnoreCase("USR_ID")) {
			return this.usrId_;
		}
		if (n.equalsIgnoreCase("USR_TAG")) {
			return this.usrTag_;
		}
		if (n.equalsIgnoreCase("ARE_ID")) {
			return this.areId_;
		}
		if (n.equalsIgnoreCase("USR_LID")) {
			return this.usrLid_;
		}
		if (n.equalsIgnoreCase("USR_PWD")) {
			return this.usrPwd_;
		}
		if (n.equalsIgnoreCase("USR_NAME")) {
			return this.usrName_;
		}
		if (n.equalsIgnoreCase("USR_IDCARD")) {
			return this.usrIdcard_;
		}
		if (n.equalsIgnoreCase("USR_TELE")) {
			return this.usrTele_;
		}
		if (n.equalsIgnoreCase("USR_EMAIL")) {
			return this.usrEmail_;
		}
		if (n.equalsIgnoreCase("USR_QQ")) {
			return this.usrQq_;
		}
		if (n.equalsIgnoreCase("USR_MSN")) {
			return this.usrMsn_;
		}
		if (n.equalsIgnoreCase("USR_ICQ")) {
			return this.usrIcq_;
		}
		if (n.equalsIgnoreCase("USR_MOBILE")) {
			return this.usrMobile_;
		}
		if (n.equalsIgnoreCase("USR_ADDR")) {
			return this.usrAddr_;
		}
		if (n.equalsIgnoreCase("USR_CDATE")) {
			return this.usrCdate_;
		}
		if (n.equalsIgnoreCase("USR_MDATE")) {
			return this.usrMdate_;
		}
		if (n.equalsIgnoreCase("USR_LDATE")) {
			return this.usrLdate_;
		}
		if (n.equalsIgnoreCase("USR_LIP")) {
			return this.usrLip_;
		}
		if (n.equalsIgnoreCase("USR_LNUM")) {
			return this.usrLnum_;
		}
		if (n.equalsIgnoreCase("USR_COMPANY")) {
			return this.usrCompany_;
		}
		if (n.equalsIgnoreCase("USR_FROM")) {
			return this.usrFrom_;
		}
		if (n.equalsIgnoreCase("USR_TITLE")) {
			return this.usrTitle_;
		}
		if (n.equalsIgnoreCase("USR_PIC")) {
			return this.usrPic_;
		}
		if (n.equalsIgnoreCase("USR_PASSPORT")) {
			return this.usrPassport_;
		}
		if (n.equalsIgnoreCase("USR_SCM")) {
			return this.usrScm_;
		}
		if (n.equalsIgnoreCase("USR_SCM_UID")) {
			return this.usrScmUid_;
		}
		if (n.equalsIgnoreCase("USR_SCM_XML")) {
			return this.usrScmXml_;
		}
		if (n.equalsIgnoreCase("USR_UNID")) {
			return this.usrUnid_;
		}
		if (n.equalsIgnoreCase("SIT_ID")) {
			return this.sitId_;
		}
		if (n.equalsIgnoreCase("SUP_ID")) {
			return this.supId_;
		}
		if (n.equalsIgnoreCase("USR_PID")) {
			return this.usrPid_;
		}
		if (n.equalsIgnoreCase("RECOMMEND_NAME")) {
			return this.recommendName_;
		}
		if (n.equalsIgnoreCase("RECOMMEND_PHONE")) {
			return this.recommendPhone_;
		}
		if (n.equalsIgnoreCase("RECOMMEND_VIP")) {
			return this.recommendVip_;
		}
		if (n.equalsIgnoreCase("AUTH_WEIXIN_ID")) {
			return this.authWeixinId_;
		}
		if (n.equalsIgnoreCase("USR_SEX")) {
			return this.usrSex_;
		}
		if (n.equalsIgnoreCase("BBS_SYS_FACE")) {
			return this.bbsSysFace_;
		}
		if (n.equalsIgnoreCase("BBS_LVL")) {
			return this.bbsLvl_;
		}
		if (n.equalsIgnoreCase("BBS_HOME_VIS_COUNT")) {
			return this.bbsHomeVisCount_;
		}
		if (n.equalsIgnoreCase("USR_PIC_BIN")) {
			return this.usrPicBin_;
		}
		if (n.equalsIgnoreCase("USR_NAME_EN")) {
			return this.usrNameEn_;
		}
		if (n.equalsIgnoreCase("USR_PARENT_NAME")) {
			return this.usrParentName_;
		}
		if (n.equalsIgnoreCase("BBS_FACE_METHOD")) {
			return this.bbsFaceMethod_;
		}
		if (n.equalsIgnoreCase("IS_WEIXIN_SUBSCRIBE")) {
			return this.isWeixinSubscribe_;
		}
		if (n.equalsIgnoreCase("BBS_POST_NUM")) {
			return this.bbsPostNum_;
		}
		if (n.equalsIgnoreCase("USR_DBO")) {
			return this.usrDbo_;
		}
		if (n.equalsIgnoreCase("BBS_REPLY_NUM")) {
			return this.bbsReplyNum_;
		}
		if (n.equalsIgnoreCase("BBS_SCORE_NUM")) {
			return this.bbsScoreNum_;
		}
		if (n.equalsIgnoreCase("BBS_NICK_NAME")) {
			return this.bbsNickName_;
		}
		if (n.equalsIgnoreCase("AUTH_WEIXIN_JSON")) {
			return this.authWeixinJson_;
		}
		if (n.equalsIgnoreCase("WX_GRP")) {
			return this.wxGrp_;
		}
		if (n.equalsIgnoreCase("WX_ID")) {
			return this.wxId_;
		}
		if (n.equalsIgnoreCase("FAVORITE")) {
			return this.favorite_;
		}
		if (n.equalsIgnoreCase("ACTIVE")) {
			return this.active_;
		}
		if (n.equalsIgnoreCase("LANGAGE_LEVEL")) {
			return this.langageLevel_;
		}
		if (n.equalsIgnoreCase("ABOUT")) {
			return this.about_;
		}
		if (n.equalsIgnoreCase("BUDDY")) {
			return this.buddy_;
		}
		if (n.equalsIgnoreCase("_SYNC_")) {
			return this.sync_;
		}
		if (n.equalsIgnoreCase("USR_TIMEZONE")) {
			return this.usrTimezone_;
		}
		if (n.equalsIgnoreCase("USR_MOBILE_COUNTRY_CODE")) {
			return this.usrMobileCountryCode_;
		}
		return null;
	}
