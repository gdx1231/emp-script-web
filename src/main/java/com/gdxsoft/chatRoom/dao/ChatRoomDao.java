 ...
 * 表chat_room操作类
 * 
 * @author gdx 时间：Tue Jun 01 2021 09:24:44 GMT+0800 (中国标准时间)
 */
public class ChatRoomDao extends ClassDaoBase<ChatRoom> implements IClassDao<ChatRoom> {
	...
	public static String[] FIELD_LIST = { "cht_rom_id", "cht_rom_name", "cht_rom_name_en", "cht_rom_memo",
			"cht_rom_memo_en", "cht_rom_status", "cht_rom_creator", "cht_rom_owner", "cht_rom_ctime", "cht_rom_mtime",
			"cht_rom_unid", "cht_rom_type", "cht_rom_ref", "cht_rom_ref_id", "cht_rom_tag0", "cht_rom_tag1",
			"cht_rom_tag2", "cht_rom_sup_id", "cht_last_id", "cht_last_time" };
